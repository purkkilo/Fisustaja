        ...
        <v-tabs-items v-model="tab" style="background: rgba(0,0,0,0.4);">
                                ...
                                <v-col v-if="!loading">
                                    <v-row>
                                        ...
                                        <v-col v-else>
                                            <h2 >Ei kilpailuja!</h2>
                                            <h2 >Luo Cup ensin</h2>
                                            <v-btn tile color="blue lighten-1" @click="tab='create'"><i class="material-icons left">add_circle_outline</i>Luo Cup!</v-btn>
                                        </v-col>
                                    </v-row>
            ...
            <v-tab-item :value="'create'">
                <v-container>
                    ...
                    <v-row>
                        <v-col>
                            <v-btn tile color="primary" @click="saveCup" :loading="loading"><i class="material-icons left">check</i>Luo Cup</v-btn>
                        </v-col>
                    </v-row>
                </v-container>
            </v-tab-item>
                    ...
                    <v-row>
                        <v-col>
                                ...
                                <table border=1 id="competitions-table" class="centered responsive-table tablearea highlight">
                                    ...
                                    <tbody>
                                        ...
                                        > 
                                            <td>{{ cup.name }}</td> 
                                            <td>{{ cup.year }}</td> 
                                            <td><v-btn tile color="primary" @click="pickCup(cup)"><i class="material-icons left">check</i>Valitse</v-btn></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <v-row v-else>
                                ...
                                <v-col v-else-if="error" class="error"><h2>{{ error }}</h2></v-col>
                                <v-col v-else>
